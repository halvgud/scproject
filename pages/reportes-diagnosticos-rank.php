...
else
{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <form id="reporteDiagnosticos">
                    <input type="hidden" name="tabla" id="tabla" value="visita">
                    <input type="hidden" name="idTransaccion"  value="22">
                    <table class="table">
                        <tbody>
                        <tr>
                            <td>
            ...
            <form id="abrirPdf" action="pdf_reporte-diagnosticos-rank.php" method="post" target="_blank">
    ...
    <script>
        ...
        $("#reporteDiagnosticos").submit(function(e){
            e.preventDefault();
            var form1 = $("#reporteDiagnosticos").find("input").serializeArray();
            var datosTabla1 = {};
            ...
            if($("#fecha_inicio").val() === '' || $("#fecha_fin").val()  === ''){
                ...
                exitoso = function(datos){
                    ...
                    $("#abrirPdf #fecha_inicio").val($("#reporteDiagnosticos #fecha_inicio").val());
                    $("#abrirPdf #fecha_fin").val($("#reporteDiagnosticos #fecha_fin").val());
                    moment.locale('es');
                    var inicio = moment($("#reporteDiagnosticos #fecha_inicio").val(),'YYYY/MM/DD');
                    var fin = moment($("#reporteDiagnosticos #fecha_fin").val(),'YYYY/MM/DD');
