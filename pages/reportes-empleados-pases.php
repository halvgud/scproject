...
else
{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <br/>
            <h1>Reporte Pases de Salida Por Empleado</h1>
            <hr>
            <div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <form id="reportePaseSalidaEmpleado">
                    <input type="hidden" name="idTransaccion"  value="23">
                    <table class="table">
                        <tbody>
                        <tr>
                            <td>
            ...
            <form id="abrirPdf" action="pdf_pasesalida_empleado_rango_fecha.php" method="post" target="_blank">
    ...
    <script>
        ...
        $("#reportePaseSalidaEmpleado").submit(function(e){
            e.preventDefault();
            var form1 = $("#reportePaseSalidaEmpleado").find("input").serializeArray();
            var datosTabla1 = {};
            ...
            if($("#fecha_inicio").val() === '' || $("#fecha_fin").val()  === ''){
                ...
                exitoso = function(datos){
                        ...
                        buttons: [
                            {
                                ...
                                action: function ( e, dt, node, config ) {
                                    ...
                                    var nombre = 'Pases_Salida_Emppleado'+$('#fecha_inicio').val()+'_'+$('#fecha_inicio').val();
                                    var header1 = 'PASES DE SALIDA POR EMPLEADO DE '+$("#abrirPdf #fecha_inicio_mostrar").val()+' A '+$("#abrirPdf #fecha_fin_mostrar").val();
                                    var header2 = 'Reporte de Pases de Salida por Empleado';
                    ...
                    $("#abrirPdf #fecha_inicio").val($("#reportePaseSalidaEmpleado #fecha_inicio").val());
                    $("#abrirPdf #fecha_fin").val($("#reportePaseSalidaEmpleado #fecha_fin").val());
                    moment.locale('es');
                    var inicio = moment($("#reportePaseSalidaEmpleado #fecha_inicio").val(),'YYYY/MM/DD');
                    var fin = moment($("#reportePaseSalidaEmpleado #fecha_fin").val(),'YYYY/MM/DD');
