...
<ul>
    <li><a href="consultasC.php"> Consultas </a></li>
      <li><a href="pasedesalida.php"> Pase de Salida </a></li>
...
<li><a href="#" >Salir</a></li>
      ...
      <div id="barra">
        <p id="estilo">PASE DE SALIDA</p>
     </div>
      <div id="general">
			<ul id="subm" class="topmenu">
			<li class="switch"><label onclick="" for="subm-switcher"></label></li>
	<li class="topfirst"><a href="pasesalidaD.php" style="width:118px;"><span><img src="imagenes/256-1.png" alt=""/>
    Agregar</span></a>
            
            <li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/find.png" alt=""/>
    Buscar</span></a>
