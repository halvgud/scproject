...
else
{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form id="abrirPdf" action="pdf_visita_empleado_rango_fecha.php" method="post" target="_blank">
