...
<li><a href="salir.php" >Salir</a></li>
      ...
      <div id="barra">
        <p id="estilo">INCAPACIDADES</p>
     </div>
      <div id="general">
			<ul id="subm" class="topmenu">
			<li class="switch"><label onclick="" for="subm-switcher"></label></li>
	<li class="topfirst"><a href="incapaform.php" style="width:118px;"><span><img src="imagenes/256sub1.png" alt=""/>
    Agregar</span></a>
            <li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/find1.png" alt=""/>
    Buscar</span></a>
			</ul>
			<div id="imagen">
