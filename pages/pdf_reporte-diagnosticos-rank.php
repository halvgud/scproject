...
'.$tabla.'</table>';
$html = '
<div style="text-align: right; position: fixed; top: 0pt;right: 20pt;"><img src="img/header.png" style="height 80pt; width: 110pt;" alt="Cardinal Health"></div>
<h1>Cirpro de Delicias</h1>
<h2>Diagnosticos '.$_POST['fecha_inicio_mostrar'].' a '.$_POST['fecha_fin_mostrar'].' </h2>
