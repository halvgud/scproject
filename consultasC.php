...
<li><a href="salir.php" >Salir</a></li>
      ...
      <div id="barra">
        <p id="estilo">CONSULTAS</p>
     </div>
      <div id="general">
			<ul id="subm" class="topmenu">
			<li class="switch"><label onclick="" for="subm-switcher"></label></li>
	<li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/service.png" alt=""/>
    Consultas</span></a>
            <ul>
		<li><a href="consulta.php"><img src="imagenes/256sub1.png" alt=""/>Agendar</a></li>
		<li><a href="#"><img src="imagenes/find1.png" alt=""/>Buscar</a></li>
	</ul></li>
            <li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/service.png" alt=""/>
    Visitas</span></a>
            <ul>
		<li><a href="visitas.php"><img src="imagenes/256sub1.png" alt=""/>Agregar</a></li>
		<li><a href="#"><img src="imagenes/find1.png" alt=""/>Buscar</a></li>
	</ul></li>      
        </ul>
			<div id="imagen">
        
		<img src="imagenes/sysco0.png" ></img>
    </div>
      </div>
