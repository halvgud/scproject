        ...
        <div id="datos">
            <form name="registroconsulta" action="procesar.php" method="post">  
                <table border="0" class="" id="datos" aling>
                    ...
                    <tr>
                        <td>Semana</td>
                        <td><input type="text" name=textosemana"/></td>
                    </tr>
                    <tr>
                        <td>Respetar</td>
                        <td><input type="text" name=textoresp"/></td>
                    </tr>
                     <tr>
                        <td>Motivo</td>
                        <td><input type="text" name=textomotivo" /></td>
                    </tr>
                     <tr>
                        <td>Sup. de Produccion</td>
                        <td><input type="text" name=textosup" /></td>
                    </tr>
