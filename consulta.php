...
<li><a href="#" >Salir</a></li>
        ...
        <div id="barra">
        <p id="estilo">Agendar Consulta</p>
     </div>
        <div id="general1">
       <div id="contenido2">
        <div id="cabezera">
        ...
        <div id="datos">
            <form name="registroconsulta" action="procesar.php" method="post">  
                <table border="0" class="" id="datos" aling>
                    ...
                    <tr>
                        <td>Area</td>
                        <td><input type="text" name=textoArea"/></td></tr>
                    <tr>
                        <td>Diagnostico</td>
                        <td>
                            <select name="Diagnos">
                    ...
                    <tr>
                        <td>Peso</td>
                         <td><input type="text"name=textopeso" maxlength="4" size="4"/></td>
                    </tr>
                    <tr>
                        <td>Talla</td>
                        <td><input type="text" name=textotalla" maxlength="4" size="4"/></td>
                    </tr>
                    <tr>
                        <td>Frec. Cardiaca</td>
                        <td><input type="text" name="textocardiaca" maxlength="4" size="4"/></td>
                    </tr>
                    <tr>
                        <td>Temperatura</td>
                        <td><input type="text" name=textotemp" maxlength="4" size="4"/></td>
                    </tr>
                    <tr>
                        <td>Frec. Respiratoria</td>
                        <td><input type="text" name=textoresp" maxlength="4" size="4"/></td>
                    </tr>
                    <tr>
                        <td colspan="3">
