...
<li><a href="#" >Salir</a></li>
      ...
      <div id="barra">
        <p id="estilo">MEDICAMENTO</p>
     </div>
      <div id="general">
			<ul id="subm" class="topmenu">
			<li class="switch"><label onclick="" for="subm-switcher"></label></li>
	<li class="topfirst"><a href="inclumedica.php" style="width:118px;"><span><img src="imagenes/256-1.png" alt=""/>
    Nuevo</span></a>
    <li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/nue.png" alt=""/>
    Actualizar</span></a>
	<li class="topfirst"><a href="#" style="width:118px;"><span><img src="imagenes/256sub2.png" alt=""/>
    Eliminar</span></a>
